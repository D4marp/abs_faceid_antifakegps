...
class _AttendanceCheckinPageState extends State<AttendanceCheckinPage> {
  ...
  doFaceDetectionOnFrame() async {
    //TDO convert frame into InputImage format
    InputImage inputImage = getInputImage();

    //TDO pass InputImage to face detection model and detect faces
    ...
    //TDO perform face recognition on detected faces
    performFaceRecognition(faces);
  }

  img.Image? image;
  bool register = false;
  // TOD perform Face Recognition
  performFaceRecognition(List<Face> faces) async {
    recognitions.clear();

    //TOD convert CameraImage to Image and rotate it so that our frame will be in a portrait
    ...
    for (Face face in faces) {
      ...
      //TOD pass cropped face to face recognition model
  ...
  // TOD method to convert CameraImage to Image
  ...
  //TOD convert CameraImage to InputImage
